...
var countries = []models.Country{
	...
	{Code: "CZ", Name: "Czechia", Flag: "🇨🇿", Currency: "CZK", Locale: "en", Lat: 50.0755, Lng: 14.4378, Zoom: 12,
...
var agencies = []models.Agency{
	...
	{ID: "ag-02", Slug: "hauptstadt-immobilien", Name: "Hauptstadt Immobilien", CountryCode: "DE", City: "Berlin",
		...
		Description: "Berlin's Altbau specialist, covering Mitte, Prenzlauer Berg, Kreuzberg and the western villa districts. Hauptstadt advises on Denkmalschutz obligations and Milieuschutz restrictions as standard."},
...
var brokerSeeds = []brokerSeed{
	...
	{"br-05", "Annika Hoffmann", "Senior Immobilienmaklerin", "ag-02", "DE", "Berlin", "+49 170 553 8841", "a.hoffmann@hauptstadt.example",
		[]string{"German", "English", "French"}, []string{"Villas", "Grunewald", "Prime residential"},
	...
	{"br-10", "Rui Almeida", "Consultor imobiliário (AMI)", "ag-05", "PT", "Lisbon", "+351 912 448 007", "rui.almeida@tejo.example",
		[]string{"Portuguese", "English", "Spanish"}, []string{"Chiado", "Restoration", "Coastal villas"},
...
var packages = []models.Package{
	{ID: "pk-basic", Name: "Basic", Tagline: "For a single private listing",
		Price: models.Money{Amount: 19, Currency: "EUR"}, DurationDays: 30, PhotoLimit: 10, BumpCount: 0,
	...
	{ID: "pk-standard", Name: "Standard", Tagline: "Most private sellers choose this",
		Price: models.Money{Amount: 39, Currency: "EUR"}, DurationDays: 60, PhotoLimit: 25, BumpCount: 2, IsPopular: true,
	...
	{ID: "pk-premium", Name: "Premium", Tagline: "Maximum exposure for one property",
		Price: models.Money{Amount: 89, Currency: "EUR"}, DurationDays: 90, PhotoLimit: 50, BumpCount: 6, IsPremium: true,
	...
	{ID: "pk-agency", Name: "Agency", Tagline: "For brokers and agencies",
		Price: models.Money{Amount: 249, Currency: "EUR"}, DurationDays: 30, PhotoLimit: 50, BumpCount: 20,

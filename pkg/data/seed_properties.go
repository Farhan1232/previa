...
var propertySeeds = []propertySeed{
	...
	{
		title: "House with garden studio in Grunewald", deal: models.DealSale, ptype: models.TypeHouse,
	...
	{
		title: "Sea-facing apartment in Barceloneta", deal: models.DealShortRent, ptype: models.TypeApartment,
	...
	{
		title: "Hillside house with infinity pool in Sarrià", deal: models.DealSale, ptype: models.TypeHouse,
	...
	{
		title: "Renovated studio in Gràcia", deal: models.DealShortRent, ptype: models.TypeApartment,
	...
	{
		title: "Coastal house with pool in Cascais", deal: models.DealSale, ptype: models.TypeHouse,
	...
	{
		title: "Modern flat near Naschmarkt", deal: models.DealShortRent, ptype: models.TypeApartment,
	...
	{
		title: "Studio apartment in Tallinn city centre", deal: models.DealShortRent, ptype: models.TypeApartment,
	...
	// ---- New categories ----------------------------------------------------
	// Realistic stock for the types the client added, spread across markets and
	// deal types so a multi-type filter returns a genuinely combined set.
	{
		title: "Upper floor of a wooden house in Kadriorg", deal: models.DealSale, ptype: models.TypeHousePart,
		country: "EE", city: "Tallinn", district: "Kadriorg", address: "Koidula 12", postal: "10150",
		price: 289000, rooms: 3, beds: 2, baths: 1, area: 86, floor: 2, floors: 2, year: 1938,
		cond: models.ConditionRenovated, energy: "D", lat: 59.4380, lng: 24.7900, broker: "br-01",
		flags: "balcony,garden,verified", imgs: []int{6, 21, 34},
		desc:    "The whole upper floor of a restored 1938 wooden house two streets from Kadriorg park, sold as a separate registered apartment. Original board floors and tiled stove retained; kitchen and bathroom rebuilt in 2021. Shared garden and a private storage room in the cellar.",
		daysAgo: 11, views: 940,
	},
	{
		title: "Half of a semi-detached house in Nõmme", deal: models.DealSale, ptype: models.TypeHousePart,
		country: "EE", city: "Tallinn", district: "Nõmme", address: "Pärnu mnt 214", postal: "11317",
		price: 345000, rooms: 4, beds: 3, baths: 2, area: 124, land: 620, floors: 2, year: 1996,
		cond: models.ConditionGood, energy: "C", lat: 59.3760, lng: 24.6890, broker: "br-02",
		flags: "garden,parking,sauna", imgs: []int{41, 52, 63},
		desc:    "One half of a 1996 semi on a 620 m² plot in Nõmme, with its own entrance, garden and driveway. Four rooms over two floors, an electric sauna off the utility room and a carport for two cars.",
		daysAgo: 26, views: 610,
	},
	{
		title: "Lakeside summer cottage near Otepää", deal: models.DealSale, ptype: models.TypeCottage,
		country: "EE", city: "Tartu", district: "Otepää", address: "Pühajärve tee 40", postal: "67405",
		price: 148000, rooms: 3, beds: 2, baths: 1, area: 68, land: 2400, floors: 1, year: 1979,
		cond: models.ConditionGood, energy: "F", lat: 58.0560, lng: 26.4970, broker: "br-03",
		flags: "garden,sauna,terrace", imgs: []int{77, 84, 91},
		desc:    "A timber cottage 300 metres from Pühajärve lake on a wooded 2,400 m² plot. Woodburning stove, separate smoke sauna and a covered terrace facing south. Water from a borehole; electricity connected year-round.",
		daysAgo: 33, views: 720,
	},
	{
		title: "Forest cottage with guest cabin in Nuuksio", deal: models.DealSale, ptype: models.TypeCottage,
		country: "FI", city: "Espoo", district: "Nuuksio", address: "Nuuksiontie 110", postal: "02820",
		price: 219000, rooms: 4, beds: 3, baths: 1, area: 92, land: 5100, floors: 1, year: 1988,
		cond: models.ConditionRenovated, energy: "E", lat: 60.3050, lng: 24.5100, broker: "br-09",
		flags: "garden,sauna,terrace,verified", imgs: []int{99, 106, 113},
		desc:    "A log cottage on the edge of Nuuksio national park, with a separate two-bed guest cabin and a lakeside sauna building. Half a hectare of mature pine. Road maintained year-round; Helsinki is 40 minutes by car.",
		daysAgo: 18, views: 1180,
	},
	{
		title: "Modular family house in Peetri", deal: models.DealSale, ptype: models.TypeModularHouse,
		country: "EE", city: "Tallinn", district: "Peetri", address: "Vabaduse tee 8", postal: "75312",
		price: 268000, rooms: 4, beds: 3, baths: 2, area: 112, land: 700, floors: 1, year: 2023,
		cond: models.ConditionNew, energy: "A", lat: 59.3820, lng: 24.8200, broker: "br-02",
		flags: "new,parking,terrace,verified", imgs: []int{12, 27, 38, 49},
		desc:    "A factory-built modular house delivered in four sections and completed on site in 2023. Air-to-water heat pump, mechanical ventilation with heat recovery and triple glazing throughout. A-class energy certificate; the plot is fully landscaped.",
		daysAgo: 6, views: 1640,
	},
	{
		title: "Two-module compact house in Vantaa", deal: models.DealSale, ptype: models.TypeModularHouse,
		country: "FI", city: "Helsinki", district: "Vantaa", address: "Kylmäojantie 22", postal: "01390",
		price: 196000, rooms: 3, beds: 2, baths: 1, area: 78, land: 520, floors: 1, year: 2022,
		cond: models.ConditionNew, energy: "A", lat: 60.3180, lng: 25.0400, broker: "br-09",
		flags: "new,parking", imgs: []int{58, 67},
		desc:    "A two-module house craned into place in 2022 on a serviced plot in Vantaa. Open living space with a full-height window wall, two bedrooms and a utility room plumbed for a sauna. Ground-source heating shared with the neighbouring plot.",
		daysAgo: 22, views: 830,
	},
	{
		title: "Panelized house in Grunewald", deal: models.DealSale, ptype: models.TypePanelizedHouse,
		country: "DE", city: "Berlin", district: "Grunewald", address: "Hagenstraße 46", postal: "14193",
		price: 845000, rooms: 6, beds: 4, baths: 3, area: 198, land: 940, floors: 2, year: 2019,
		cond: models.ConditionNew, energy: "A", lat: 52.4870, lng: 13.2700, broker: "br-05",
		flags: "featured,new,garden,parking,verified", imgs: []int{14, 29, 44, 61, 78},
		desc:    "Built from prefabricated wall panels in 2019 to a KfW 55 standard. Six rooms over two floors, underfloor heating throughout and a double garage. The 940 m² plot backs onto woodland with no rear neighbour.",
		daysAgo: 14, views: 2270,
	},
	{
		title: "Panel-built townhouse in Karlín", deal: models.DealRent, ptype: models.TypePanelizedHouse,
		country: "CZ", city: "Prague", district: "Karlín", address: "Sokolovská 190", postal: "18600",
		price: 2400, rooms: 5, beds: 3, baths: 2, area: 156, floors: 3, year: 2020,
		cond: models.ConditionNew, energy: "B", lat: 50.0940, lng: 14.4600, broker: "br-14",
		flags: "new,parking,balcony", imgs: []int{86, 95, 102},
		desc:    "One of six panel-built townhouses completed in 2020 beside the Karlín riverfront. Three floors, a roof terrace and a garage bay in the shared undercroft. Available unfurnished on a minimum twelve-month term.",
		daysAgo: 9, views: 1050,
	},
	{
		title: "Trailer house on a serviced pitch in Pärnu", deal: models.DealSale, ptype: models.TypeTrailerHouse,
		country: "EE", city: "Pärnu", district: "Raeküla", address: "Ranna puiestee 6", postal: "80012",
		price: 46000, rooms: 2, beds: 1, baths: 1, area: 32, floors: 1, year: 2021,
		cond: models.ConditionNew, energy: "C", lat: 58.3720, lng: 24.4900, broker: "br-03",
		flags: "new,terrace", imgs: []int{121},
		desc:    "A road-legal trailer house on a serviced seasonal pitch ten minutes from Pärnu beach. Insulated to year-round standard with a heat pump, a wet room and a fold-out terrace. Pitch rent is €95 per month including water and power.",
		daysAgo: 29, views: 380,
	},
	{
		title: "Mobile home with sea view in Cascais", deal: models.DealRent, ptype: models.TypeTrailerHouse,
		country: "PT", city: "Lisbon", district: "Cascais", address: "Estrada do Guincho 210", postal: "2750-642",
		price: 1150, rooms: 3, beds: 2, baths: 1, area: 44, floors: 1, year: 2020,
		cond: models.ConditionGood, energy: "C", lat: 38.7250, lng: -9.4600, broker: "br-11",
		flags: "furnished,terrace,seaview", imgs: []int{124, 131},
		desc:    "A fully furnished mobile home on a private plot above Guincho, let year-round. Two bedrooms, a covered deck facing the Atlantic and off-road parking for two cars. Bills are settled directly with the site.",
		daysAgo: 16, views: 690,
	},
	{
		title: "Lakeside smoke sauna with changing room", deal: models.DealSale, ptype: models.TypeSauna,
		country: "FI", city: "Tampere", district: "Teisko", address: "Näsijärventie 340", postal: "34260",
		price: 39000, rooms: 2, area: 26, land: 900, floors: 1, year: 2015,
		cond: models.ConditionGood, energy: "F", lat: 61.7200, lng: 23.9600, broker: "br-09",
		flags: "sauna,terrace,seaview", imgs: []int{136},
		desc:    "A traditional smoke sauna directly on the Näsijärvi shoreline, with a changing room, a covered porch and its own jetty. Sold with a 900 m² leasehold shore plot. Used three seasons a year; the stove was relined in 2022.",
		daysAgo: 37, views: 460,
	},
	{
		title: "Detached electric sauna building in Viimsi", deal: models.DealSale, ptype: models.TypeSauna,
		country: "EE", city: "Tallinn", district: "Viimsi", address: "Randvere tee 88", postal: "74001",
		price: 24500, rooms: 2, area: 18, land: 300, floors: 1, year: 2020,
		cond: models.ConditionNew, energy: "D", lat: 59.5050, lng: 24.8300, broker: "br-02",
		flags: "new,sauna,terrace", imgs: []int{139},
		desc:    "A standalone sauna building with a glazed relaxation room and a small terrace, on a 300 m² corner of a larger plot sold separately. Electric heater, shower and a composting WC. Ready to connect to mains water.",
		daysAgo: 24, views: 290,
	},
	{
		title: "New development apartment at Pärli Residents", deal: models.DealSale, ptype: models.TypeNewDevelopment,
		country: "EE", city: "Tallinn", district: "Kalamaja", address: "Vabriku 33", postal: "10411",
		price: 312000, rooms: 3, beds: 2, baths: 1, area: 74, floor: 4, floors: 6, year: 2026,
		cond: models.ConditionNew, energy: "A", lat: 59.4470, lng: 24.7350, broker: "br-01",
		flags: "featured,new,balcony,elevator,parking,verified", imgs: []int{17, 32, 47, 54},
		desc:    "A third-floor apartment in the Pärli Residents scheme, completing in autumn 2026. Two bedrooms, a south-facing balcony and a storage unit in the basement. Reserved off-plan with a 15% deposit; the remainder is due on handover.",
		daysAgo: 4, views: 2890,
	},
	{
		title: "New development duplex at Eedu Apartemendid", deal: models.DealSale, ptype: models.TypeNewDevelopment,
		country: "EE", city: "Tallinn", district: "Kesklinn", address: "Ahtri 22", postal: "10151",
		price: 498000, rooms: 4, beds: 3, baths: 2, area: 118, floor: 8, floors: 9, year: 2026,
		cond: models.ConditionNew, energy: "A", lat: 59.4420, lng: 24.7620, broker: "br-01",
		flags: "featured,new,terrace,elevator,parking,seaview,verified", imgs: []int{22, 39, 56, 71},
		desc:    "A top-floor duplex in the Eedu scheme with a 30 m² roof terrace looking over the port towards the bay. Four rooms across two levels, two parking bays and a storage cage included. Completion scheduled for Q4 2026.",
		daysAgo: 2, views: 3410,
	},
	// ---- Industrial property ----------------------------------------------
	// The client's examples: factories, store halls, workshops and car repair
	// garages. Spread across markets and both deal types so the category
	// returns a realistic mix on its own and inside a multi-type selection.
	{
		title: "Light manufacturing unit in Tallinn Lasnamäe", deal: models.DealSale, ptype: models.TypeIndustrial,
		country: "EE", city: "Tallinn", district: "Lasnamäe", address: "Peterburi tee 92", postal: "13816",
		price: 720000, rooms: 6, area: 1450, land: 3200, floors: 1, year: 2008,
		cond: models.ConditionGood, energy: "D", lat: 59.4290, lng: 24.8600, broker: "br-02",
		flags: "parking,verified", imgs: []int{128, 133},
		desc:    "A 1,450 m² production hall with 7.2-metre clear height, two dock levellers and a ground-level door. Three-phase 250 A supply, overhead crane rails in the main bay and 180 m² of offices over two floors. Fenced yard with parking for eighteen.",
		daysAgo: 19, views: 640,
	},
	{
		title: "Storage hall with mezzanine in Vantaa", deal: models.DealRent, ptype: models.TypeIndustrial,
		country: "FI", city: "Helsinki", district: "Vantaa", address: "Ansatie 4", postal: "01740",
		price: 4200, rooms: 4, area: 980, floors: 2, year: 2014,
		cond: models.ConditionGood, energy: "C", lat: 60.2950, lng: 24.9600, broker: "br-09",
		flags: "parking", imgs: []int{135, 141},
		desc:    "A 980 m² insulated store hall close to Ring III, with a 210 m² mezzanine and two sectional doors. Sprinklered, alarmed and let with eight parking bays. Suits distribution, trade counter or light assembly.",
		daysAgo: 12, views: 880,
	},
	{
		title: "Car repair workshop with four bays in Prague", deal: models.DealSale, ptype: models.TypeIndustrial,
		country: "CZ", city: "Prague", district: "Ostrava", address: "Nádražní 210", postal: "70200",
		price: 385000, rooms: 5, area: 620, land: 1100, floors: 1, year: 1996,
		cond: models.ConditionRenovated, energy: "E", lat: 49.8350, lng: 18.2900, broker: "br-14",
		flags: "parking,verified", imgs: []int{143, 147},
		desc:    "A working car repair garage with four bays, two two-post lifts and an inspection pit, sold with the business fittings in place. Compressed air ring main, waste-oil interceptor and a customer reception with a small parts store. Yard for twelve vehicles.",
		daysAgo: 31, views: 520,
	},
	{
		title: "Workshop and trade counter in Berlin Spandau", deal: models.DealRent, ptype: models.TypeIndustrial,
		country: "DE", city: "Berlin", district: "Spandau", address: "Brunsbütteler Damm 140", postal: "13581",
		price: 3100, rooms: 3, area: 540, floors: 1, year: 2003,
		cond: models.ConditionGood, energy: "D", lat: 52.5340, lng: 13.1800, broker: "br-05",
		flags: "parking", imgs: []int{150, 154},
		desc:    "A 540 m² workshop unit with a glazed trade counter to the street, roller shutter access to the rear and 4.8-metre eaves. Three-phase power, LED lighting throughout and a small yard. Available on a flexible three- or five-year term.",
		daysAgo: 7, views: 1120,
	},
}
